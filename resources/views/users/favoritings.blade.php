    ...
    <div class="row">
        ...
        <div class="col-xs-8">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li role="presentation" class="{{ Request::is('users/*/favoriters') ? 'active' : '' }}"><a href="{{ route('users.favoriters', ['id' => $user->id]) }}">Favoriters <span class="badge">{{ $count_favoriters }}</span></a></li>
            </ul>
